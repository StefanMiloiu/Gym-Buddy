...
#Preview {
    CustomExerciseView(exercise: Exercise(bodyPart: "upper legs", equipment: "body weight", gifUrl: "https://v2.exercisedb.io/image/NnZC1Wzq6EscDG", id: "1256", name: "world greatest stretch", target: "hamstrings"))
}
